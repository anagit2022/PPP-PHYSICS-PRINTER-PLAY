...
// Paste your deployed Apps Script URL (ends in /exec) and the SECRET you
// set inside DriveUpload.gs. This file is sent to the browser as plain
// text, so anyone who opens dev tools can read these values — fine for a
